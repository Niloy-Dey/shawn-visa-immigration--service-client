        ...
        <div>
            <footer class="footer p-10 bg-black text-white ">
                <div>
                    ...
                    <p class="link link-hover">immigration</p>
                ...
                <div>
                    ...
                    <p class="link link-hover">visa</p>
                    <p class="link link-hover">Tour</p>
                </div>
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-black text-white  border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p>Shawnpeterllc.co.uk <br />Providing reliable tech since 2022</p>
                </div>
